        ...
        <div class="space-y-8">
            <section class="bg-white p-6 rounded-lg shadow-md border border-slate-200">
                ...
                <div class="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div>
                        <img
                        alt="The interior of a clean goat shelter with deep straw bedding"
                        class="rounded-lg shadow-sm"
                        src="&lt;?= e($REL) ?&gt;assets/site/assets/goat-shelter-interior.jpg" />
                    </div>
                </div>
            </section>
            <section class="bg-white p-6 rounded-lg shadow-md border border-slate-200">
                ...
                <div class="grid md:grid-cols-2 gap-6 items-center">
                    <div>
                        <img
                        alt="A close-up of strong woven wire fencing suitable for goats"
                        class="rounded-lg shadow-sm"
                        src="&lt;?= e($REL) ?&gt;assets/site/assets/secure-goat-fence.jpg" />
                    </div>
                    <div>
