        ...
        <div class="space-y-12">
            ...
            <section class="bg-white p-6 rounded-lg shadow-md border border-slate-200">
                ...
                <div class="grid md:grid-cols-2 gap-6 items-start">
                    ...
                    <div>
                        <img
                        alt="A clean and prepared kidding stall with deep straw bedding."
                        class="rounded-lg shadow-sm"
                        src="&lt;?= e($REL) ?&gt;assets/site/assets/goat-kidding-stall-clean.jpg" />
                    </div>
                </div>
            </section>
            <section class="bg-white p-6 rounded-lg shadow-md border border-slate-200">
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div class="flex justify-center items-center">
                        <img
                        alt="A mother goat with her newborn kids."
                        class="w-full max-w-sm h-auto"
                        src="&lt;?= e($REL) ?&gt;assets/site/assets/goat-kids.svg" />
                    </div>
                </div>
                <div
                class="mt-6 bg-red-50 border-l-4 border-red-500 text-red-800 p-4 rounded-r-lg text-sm">
