...
<main class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
    <div class="max-w-4xl mx-auto">
        <section class="mb-12 text-center">
            <h1 class="text-4xl sm:text-5xl font-bold text-slate-900 tracking-tight mb-4">Breeding &amp; <a href="/glossary-resources#kidding" class="text-emerald-600 hover:underline font-semibold">Kidding</a></h1>
        ...
        <div class="space-y-12">
            <section class="bg-white p-6 rounded-lg shadow-md border border-slate-200">
                ...
                <p class="text-slate-600 mb-4">Most dairy goat breeds are seasonal breeders, typically coming into <a href="/glossary-resources#heat" class="text-emerald-600 hover:underline font-semibold">heat</a> in the fall as the days get shorter. Nigerian Dwarfs and some meat breeds can cycle year-round.</p>
                <ul class="space-y-3 list-disc list-inside text-slate-700">
                    <li><strong>Heat (Estrus):</strong> A <a href="/glossary-resources#doe" class="text-emerald-600 hover:underline font-semibold">doe's</a> heat cycle is about 18-24 days long. The period when she is receptive to a <a href="/glossary-resources#buck" class="text-emerald-600 hover:underline font-semibold">buck</a>, called "standing heat," lasts for 12-48 hours. This is the only time she can get pregnant.</li>
            ...
            <section class="bg-white p-6 rounded-lg shadow-md border border-slate-200">
                ...
                <div class="grid md:grid-cols-2 gap-6 items-start">
                    ...
                    <div>
                        <img alt="A clean and prepared kidding stall with deep straw bedding." class="rounded-lg shadow-sm" src="/assets/site/assets/goat-kidding-stall-clean.jpg" />
                    </div>
                </div>
            </section>
            <section class="bg-white p-6 rounded-lg shadow-md border border-slate-200">
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div class="flex justify-center items-center">
                        <img alt="A mother goat with her newborn kids." class="w-full max-w-sm h-auto" src="/assets/site/assets/goat-kids.svg" />
                    </div>
                </div>
        ...
        <div class="flex justify-between items-center pt-12">
            <a class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 text-sm font-medium text-slate-700 rounded-md shadow-sm hover:bg-slate-50 transition-colors" href="/hoof-care-grooming">
                <svg fill="none" height="16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
                    <path d="m15 18-6-6 6-6"></path>
                </svg>
                Previous
            </a>
            <a class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 border border-transparent text-sm font-medium text-white rounded-md shadow-sm hover:bg-emerald-700 transition-colors" href="/bottle-feeding-kid-care">
                Next
                <svg fill="none" height="16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
